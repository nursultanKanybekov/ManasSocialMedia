    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/competitions/new").hasAnyRole("SECRETARY", "ADMIN", "MEZUN", "TEACHER", "EMPLOYER")
                        .requestMatchers("/events/new").hasAnyRole("SECRETARY", "ADMIN", "MEZUN", "TEACHER", "EMPLOYER")
